...
func (m *MockRepo) GetAccountByNumber(n string) (*models.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAccountByNumber", n)
	ret0, _ := ret[0].(*models.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRepoMockRecorder) GetAccountByNumber(n interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAccountByNumber", reflect.TypeOf((*MockRepo)(nil).GetAccountByNumber), n)
}

// GetCustomerByAccountID mocks base method.
func (m *MockRepo) GetCustomerByAccountID(id int) (*models.Customer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetCustomerByAccountID", id)
...
func (mr *MockRepoMockRecorder) GetCustomerByAccountID(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCustomerByAccountID", reflect.TypeOf((*MockRepo)(nil).GetCustomerByAccountID), id)
}
