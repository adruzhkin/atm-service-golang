...
//
//	mockgen -source=db/repository.go -destination=mocks/repository_mock.go -package=mocks
//
...
func (mr *MockRepoMockRecorder) CreateCustomer(c any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRepoMockRecorder) CreateTransaction(tx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRepoMockRecorder) GetCustomerByCredentials(crd any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRepoMockRecorder) GetCustomerByEmail(email any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRepoMockRecorder) GetTransactionsBalanceByAccountID(id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRepoMockRecorder) GetTransactionsByAccountID(id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
